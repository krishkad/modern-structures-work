                    ...
                    {carouselImg.map((item, index) => (
                        <CarouselItem key={index} className="pointer-events-none">
                            <div className="p-0 pointer-events-none">
                                <div className="relative pointer-events-none bg-white w-full h-[calc(50svh)] sm:h-[calc(100svh-80px)]">
                                    <img src={item.img} width={500} height={500} className="w-full h-full object-cover pointer-events-none" sizes="(max-width: 768px) 100vw, 33vw" alt="img" />
                                </div>
                            </div>
                        </CarouselItem>
                    ))}
