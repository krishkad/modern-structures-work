...
const NavButton = ({ item }: { item: { label: string, href?: string } }) => {
    return (
        <Link href={'/'} className={cn(buttonVariants({ variant: 'ghost', size: 'sm' }), ' font-bold relative bg-white rounded-none group hover:bg-white hover:transition-all px-[5px] h-max py-1 ')}>
